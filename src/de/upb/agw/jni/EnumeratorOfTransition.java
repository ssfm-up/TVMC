...
*/
public class EnumeratorOfTransition extends Object {
/**
...
public EnumeratorOfTransition(Long __imp) { implementation = __imp; }
protected Long implementation = null;
protected boolean extensible = false;
public Long getCxxwrapImpl() { return implementation; }
// override equals() from Object, compare the implementation value
public boolean equals(Object o) {
  if (!(o instanceof EnumeratorOfTransition)) return false;
  return implementation.equals(((EnumeratorOfTransition)o).implementation);
}
