...
*/
public class EnumeratorOfState extends Object {
/**
...
return (__retval == 0 ? null : new State(new Long(__retval)));
}
...
public EnumeratorOfState(Long __imp) { implementation = __imp; }
protected Long implementation = null;
protected boolean extensible = false;
public Long getCxxwrapImpl() { return implementation; }
// override equals() from Object, compare the implementation value
public boolean equals(Object o) {
  if (!(o instanceof EnumeratorOfState)) return false;
  return implementation.equals(((EnumeratorOfState)o).implementation);
}
