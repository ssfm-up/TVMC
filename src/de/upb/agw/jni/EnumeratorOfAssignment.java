...
*/
public class EnumeratorOfAssignment extends Object {
/**
...
return (__retval == 0 ? null : new Assignment(new Long(__retval)));
}
...
public EnumeratorOfAssignment(Long __imp) { implementation = __imp; }
protected Long implementation = null;
protected boolean extensible = false;
public Long getCxxwrapImpl() { return implementation; }
// override equals() from Object, compare the implementation value
public boolean equals(Object o) {
  if (!(o instanceof EnumeratorOfAssignment)) return false;
  return implementation.equals(((EnumeratorOfAssignment)o).implementation);
}
