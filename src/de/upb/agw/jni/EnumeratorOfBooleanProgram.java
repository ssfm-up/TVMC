...
*/
public class EnumeratorOfBooleanProgram extends Object {
/**
...
This method may <var>not</var> be extended in Java.
*/
public BooleanProgram getNext()
{
long __retval = 0;
__retval = __m6(implementation.longValue());
return (__retval == 0 ? null : new BooleanProgram(new Long(__retval)));
}
...
public EnumeratorOfBooleanProgram(Long __imp) { implementation = __imp; }
protected Long implementation = null;
protected boolean extensible = false;
public Long getCxxwrapImpl() { return implementation; }
// override equals() from Object, compare the implementation value
public boolean equals(Object o) {
  if (!(o instanceof EnumeratorOfBooleanProgram)) return false;
  return implementation.equals(((EnumeratorOfBooleanProgram)o).implementation);
}
